...
void main() {
  ...
  //
  // Двух строк на 320×640 и без ряда нет: им нужно 154 точки, списку
  // достаётся 83. Остальное придётся взять у сцены, кассы или пульта — это
  // решает владелец, см. «Магазин на низком экране» в docs/ROADMAP.md. Когда
  // решит, порог здесь поднимется до двух.
  for (final (screen, rows) in const [(Size(320, 640), 1), (Size(390, 844), 2)]) {
    testWidgets(
