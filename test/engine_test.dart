...
void main() {
  ...
  group('Похмелье', () {
    ...
    // Без вех: здесь проверяется вес самой мудрости, а за 10 мудрости веха
    // ещё и удваивает банку. Вехи — в test/wisdom_milestones_test.dart.
    test('мудрость ускоряет следующий заход', () => withBalance(
        kBalance.copyWith(wisdomMilestones: const []), () {
      final plain = fresh();
