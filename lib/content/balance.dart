...
const List<BalanceRelease> kBalanceLog = [
  ...
  BalanceRelease(
    version: 6,
    title: 'Житейские неприятности',
    // Не ослабление — по той же причине, что и участковый: ни одно прежнее
    // число не стало хуже, а новая неприятность громкая и переживается.
    // Бьёт она только по покупке и продаже, и любую можно переждать; кто не
    // играет, тот не платит ничего.
    changes: [
      'Иногда дорожает сахар: минут на двенадцать аппараты и улучшения '
          'обходятся на треть дороже. Над магазином висит полоса с отсчётом — '
          'можно купить сейчас, а можно переждать.',
      'Иногда к Петровичу приезжает тёща, и он берёт с оглядкой: платит '
          'меньше обычного. Гостей это не касается — самое время придержать '
          'бак или дождаться шабашки.',
      'Производство неприятности не трогают. Пока игра закрыта, не теряется '
          'ничего.',
