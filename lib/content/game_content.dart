...
/// Аппарат-портал — последняя ступень лестницы, коллайдер. Первая его
/// покупка записывает снимок портала (`GameEngine.buyGenerator`).
///
/// По месту в лестнице, а не по имени — так же, как наценка портала в
/// [_tierBaseCost]: встань за коллайдером новая ступень, портал и его цена
/// уедут на неё вместе, а не разойдутся.
String get kPortalStillId => kGeneratorNames.last.id;
