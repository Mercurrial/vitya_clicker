...
///
/// Только тёплое: медь, латунь, дерево и свет лампочки. Фон — тёплый
/// почти-чёрный (#14100C), а не чистый чёрный: тёплые тёмные поверхности
/// читаются мягче и лучше держат тени.
///
